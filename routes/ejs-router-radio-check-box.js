...
router.post('/testform',(req,res)=>{  
    ...
    const choiceradio = req.body.radiochoice
    const age = req.body.age
    const vehicle = [req.body.vehicle1, req.body.vehicle2, req.body.vehicle3]
    //console.log(vehicle)
    res.render('testform.ejs',{choiceradio, age, vehicle} )
...
router.post('/login',(req,res)=>{
    ...
    const timeExpire = 300000 // 300 วินาที หรือ 5 นาที
